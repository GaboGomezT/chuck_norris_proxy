...
resource "aws_iam_role" "eb_service" {
  name = "elastic_beanstalk_service_role_v3"
...
resource "aws_iam_role_policy" "eb_service" {
  name = "elastic_beanstalk_service_policy_v3"
...
resource "aws_iam_role" "eb_ec2_role" {
  name = "aws-elasticbeanstalk-ec2-role-v3"
...
resource "aws_iam_instance_profile" "eb_ec2_profile" {
  name = "aws-elasticbeanstalk-ec2-profile-v3"
...
resource "aws_elastic_beanstalk_environment" "app" {
  name                = "chuck-norris-proxy-env-v3"
